...
g++ $CXXFLAGS -o rgblights.lnx rgblights/rgblights.cpp Demo/Demo.cpp Demo/dbusmgr.cpp \
...
g++ $CXXFLAGS -o rgblights-hidapi-libusb.lnx rgblights/rgblights.cpp Demo/Demo.cpp Demo/dbusmgr.cpp \
	Demo/LiquidColorGenerator.cpp Demo/PulseAudioSoundManager.cpp  Demo/SoundManagerBase.cpp -I./rgblights \
