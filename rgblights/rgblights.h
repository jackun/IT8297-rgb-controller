...
namespace rgblights {
	...
	struct LED4
	{
		...
		uint8_t b;
		uint8_t x;
		LED4 operator*(const LED4& o)
		{
			LED4 n;
			n.r = static_cast<uint8_t>(r * o.r / 255u);
			n.g = static_cast<uint8_t>(g * o.g / 255u);
			n.b = static_cast<uint8_t>(b * o.b / 255u);
			//x = static_cast<uint8_t>(x * o.x / 255u);
			return n;
		}
		LED4 operator*(const LEDs& o)
		{
			LED4 n;
			n.r = static_cast<uint8_t>(r * o.r / 255u);
			n.g = static_cast<uint8_t>(g * o.g / 255u);
		...
		LED4& operator*=(const LEDs& o)
		{
			r = static_cast<uint8_t>(r * o.r / 255u);
			g = static_cast<uint8_t>(g * o.g / 255u);
			b = static_cast<uint8_t>(b * o.b / 255u);
			return *this;
		}
	};
